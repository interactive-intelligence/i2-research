---
title: Tips for Getting Started with Research
description: Practical advice for beginning researchers in AI, machine learning, and neuroscience.
---
...
- Use resources like [Semantic Scholar](https://www.semanticscholar.org), [arXiv](https://arxiv.org), or [Google Scholar](https://scholar.google.com) to find influential papers.
...
- Ask questions — in person, in office hours, or in public forums like the [ML Subreddit](https://www.reddit.com/r/MachineLearning/) or Discord communities around specific tools and frameworks.
...
## Manage Scope and Avoid Rabbit Holes
