...
<UrlBadge url="https://arxiv.org/abs/1706.03762" title="Attention Is All You Need" description="Vaswani et al., 2017 — the original transformer paper" />
<UrlBadge url="https://jalammar.github.io/illustrated-transformer/" title="The Illustrated Transformer" description="Jay Alammar's visual walkthrough of the transformer architecture" />
<UrlBadge url="https://arxiv.org/abs/1810.04805" title="BERT: Pre-training of Deep Bidirectional Transformers" description="Devlin et al., 2019 — BERT and the era of pre-trained language models" />
